...
//                    .frame(height: 25)
                    ...
                    Toggle(isOn: $showSfSymbols) {
                            Text("Show EMOJIS")
                                .foregroundColor(ThemeColors().fontMainColour)
                                .font(.caption)
...
//                .frame(height: 290, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                ...
                HStack {
                    ...
                    .padding(10)
                    .background(ThemeColors().bgSecondaryColour)
                    .foregroundColor(ThemeColors().fontSecondaryColour)
                    .cornerRadius(10)
