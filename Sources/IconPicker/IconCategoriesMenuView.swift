        ...
        HStack(spacing:-1) {
            Button(action: {
                ...
                Image(systemName: "pin")
                    ...
                    .overlay(selectedThemeColors.fontMainColour
            ...
            .popoverView(content: {Text("PINNED").foregroundColor(.white)}, background: {selectedThemeColors.fontMainColour.opacity(0.6)}, isPresented: self.$PHSAndAllCategoriesToolTipsVisibilityArray[0], frame: .constant(CGRect(x: 200, y: 0, width: 80, height: 30)), anchorFrame: nil, popoverType: .popout, position: .topRight, viewId: "thirdPopover", settings: DYPopoverViewSettings(arrowLength: 10, offset: CGSize(width: 15, height: -10)))
            ...
            .popoverView(content: {Text("HISTORY").foregroundColor(.white)}, background: {selectedThemeColors.fontMainColour.opacity(0.6)}, isPresented: self.$PHSAndAllCategoriesToolTipsVisibilityArray[1], frame: .constant(CGRect(x: 200, y: 0, width: 80, height: 30)), anchorFrame: nil, popoverType: .popout, position: .top, viewId: "thirdPopover", settings: DYPopoverViewSettings(arrowLength: 10, offset: CGSize(width: 10, height: 0)))
            //
            Button(action: {
            ...
            .popoverView(content: {Text("SUGGESTIONS").foregroundColor(.white)}, background: {selectedThemeColors.fontMainColour.opacity(0.6)}, isPresented: self.$PHSAndAllCategoriesToolTipsVisibilityArray[2], frame: .constant(CGRect(x: 0, y: 0, width: 140, height: 30)), anchorFrame: nil, popoverType: .popout, position: .top, viewId: "thirdPopover", settings: DYPopoverViewSettings(arrowLength: 10, offset: CGSize(width: 10, height: 0)))
